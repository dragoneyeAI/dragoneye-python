...
class Classification:
    ...
    async def _predict_unified(
        ...
        **kwargs: Any,
        ...
        molecule_backend_override: str | None = kwargs.get("molecule_backend_override")
        ...
        if molecule_backend_override is not None:
            predict_data["molecule_backend_override"] = molecule_backend_override
